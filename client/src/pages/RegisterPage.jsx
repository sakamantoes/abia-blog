...
import { FiUser, FiMail, FiLock, FiUserPlus, FiEye, FiEyeOff, FiArrowRight } from 'react-icons/fi';
...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-gray-50 py-12 px-4 flex items-center justify-center">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <motion.div variants={fadeInUp} className="text-center md:text-left">
              <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 text-white shadow-2xl">
                ...
                <p className="text-green-100 mb-6">
                  Create an account to engage with Abia State's digital platform and stay informed.
                </p>
                
                <div className="space-y-4 text-sm text-green-100">
                  <motion.div variants={itemVariants} className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-green-300 rounded-full"></div>
                    <span>Get personalized news feed</span>
                  </motion.div>
                  <motion.div variants={itemVariants} className="flex items-center gap-3">
                    <div className="w-2 h-2 bg-green-300 rounded-full"></div>
          ...
          >
            ...
            >
              ...
              <div className="bg-gradient-to-r from-green-600 to-green-700 px-8 py-6">
                ...
                <p className="text-green-100 text-center text-sm mt-1">
                  Join the Abia State digital community
                </p>
              </div>
            ...
            >
              <p className="text-sm text-purple-900 font-semibold mb-2">✨ Benefits of Joining</p>
              <div className="grid grid-cols-2 gap-2 text-xs text-purple-800">
                <div>✓ Like & comment on posts</div>
